CC312_CCM - Demonstrates using CCM for message authentication
=============================================================
...
Overview
--------
This application demonstrates the ability to perform CCM encryption and
authentication operations using the standard NIST sample data.
