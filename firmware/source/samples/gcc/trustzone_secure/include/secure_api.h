 ...
 */
extern int __attribute__ ((cmse_nonsecure_entry)) NSC_Func_Dec(int x);
 ...
 */
extern int __attribute__ ((cmse_nonsecure_entry)) NSC_Func_Inc(int x);

extern void __attribute__ ((cmse_nonsecure_entry)) NSC_GPIO_Toggle();
