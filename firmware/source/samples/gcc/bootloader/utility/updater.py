...
def eval_header(img, offset):
    ...
    usagefault_hander, secureFault_handler, version_ptr, dscr_ptr) = struct.unpack_from("<10L", img, offset)
...
def load_image(file):
    ...
    # Image start address (0x00158000)
    img_start = 1409024
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Updates the device with a firmware image file over UART.')
