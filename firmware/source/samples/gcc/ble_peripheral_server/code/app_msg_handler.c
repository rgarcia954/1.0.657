...
struct ble_device_parameter ble_dev_params =
{
	...
	.low_pwr_clk =
	{
		.low_pwr_clk_src_xtal32 = LPCLK_SRC_XTAL32,
		.low_pwr_clk_src_rc32 = LPCLK_SRC_RC32,
...
{
    /* BLE Standard Profile/s and Custom Service/s will be added in following sequence:
     * 1. Add BLE BASS (step 3) at GAPM_SET_DEV_CONFIG
     * 2. Add BLE DISS (step 4(a)) at GAPM_PROFILE_ADDED_IND
     * 3. Add Custom Service 0 (step 4(b)) at GAPM_PROFILE_ADDED_IND
     * 4. Add Custom Service 1 (step 5(a)) at GATTM_ADD_SVC_RSP
     * 5. Create advertising activity (step 5(b)) at GATTM_ADD_SVC_RSP
     *
	 * Note: The above sequence is for illustration purpose,
	 * 		 since BLE profiles and Custom Service(s) can be added in any order.
     */
    ...
    switch(msg_id)
    {
        case GAPM_CMP_EVT:
        {
            ...
            if(p->operation == GAPM_RESET) /* Step 2 */
            {
                ...
                GATT_SetEnvData(NULL, app_cust_svc_db, APP_NUM_CUST_SVC);
                    ...
                    p->status == GAP_ERR_NO_ERROR) /* Step 3 - BASS profile added */
            {
        ...
        case GAPM_PROFILE_ADDED_IND: /* Step 4 */
        {
            ...
            {
                if(p->prf_task_id == TASK_ID_BASS)	/* Step 4(a) - DISS profile added */
                {
                ...
                if(p->prf_task_id == TASK_ID_DISS)	/* Step 4(b) - Custom Service 0 added */
                {
        ...
        case GATTM_ADD_SVC_RSP: /* Step 5 */
        {
            ...
            if(GATTM_GetServiceAddedCount() < APP_NUM_CUST_SVC)	/* Step 5(a) - Custom Service 1 added */
            {
