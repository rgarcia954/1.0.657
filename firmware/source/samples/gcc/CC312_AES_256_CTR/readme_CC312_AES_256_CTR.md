CC312_AES_256_CTR - AES Encryption Sample
=========================================
...
Overview
--------
This application demonstrates the use of the mbedtls library to perform
AES-CTR encryption over a large data set.
