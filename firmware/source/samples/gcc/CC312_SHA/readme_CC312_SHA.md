CC312_SHA - Demonstrates using various SHA operations to sign messages
======================================================================
...
Overview
--------
This application demonstrates the use of supported SHA algorithms and
compares the resulting signatures against NIST expected results.
