...
#if (RTE_GPIO0_EN)
	.timer_cfg.gpio_mode     = RTE_TIMER0_GPIO_MODE_DEFAULT,    /* Timer 0 GPIO default mode */
	.timer_cfg.gpio_int      = RTE_TIMER0_GPIO_INT_DEFAULT      /* Timer 0 default GPIO value */
...
#if (RTE_GPIO1_EN)
	.timer_cfg.gpio_mode     = RTE_TIMER1_GPIO_MODE_DEFAULT,    /* Timer 1 GPIO default mode */
	.timer_cfg.gpio_int      = RTE_TIMER1_GPIO_INT_DEFAULT      /* Timer 1 default GPIO value */
#endif /* if (RTE_GPIO_EN) */
};
...
#if (RTE_GPIO2_EN)
	.timer_cfg.gpio_mode     = RTE_TIMER2_GPIO_MODE_DEFAULT,    /* Timer 2 GPIO default mode */
	.timer_cfg.gpio_int      = RTE_TIMER2_GPIO_INT_DEFAULT      /* Timer 2 default GPIO value */
#endif /* if (RTE_GPIO_EN) */
};
...
#if (RTE_GPIO3_EN)
	.timer_cfg.gpio_mode     = RTE_TIMER3_GPIO_MODE_DEFAULT,    /* Timer 3 GPIO default mode */
	.timer_cfg.gpio_int      = RTE_TIMER3_GPIO_INT_DEFAULT      /* Timer 3 default GPIO value */
#endif /* if (RTE_GPIO_EN) */
};
