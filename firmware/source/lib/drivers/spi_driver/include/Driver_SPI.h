/**
 * @file Driver_SPI.h
 * @brief SPI header file for RSLxx family of devices
 */
/*
 ...
 */
/**
 * @defgroup CMSISDRVSPIg CMSIS SPI Driver
 * @brief CMSIS SPI Driver Reference
 * @{
 */
#ifdef  __cplusplus
extern "C"
...
#define ARM_SPI_API_VERSION ARM_DRIVER_VERSION_MAJOR_MINOR(2,2)  ///< SPI API version.


/****** SPI Control Codes *****/

#define ARM_SPI_CONTROL_Pos              0                                  ///< Position of the 0th bit of the SPI Control field in the ARM_SPI structure.
#define ARM_SPI_CONTROL_Msk             (0xFFUL << ARM_SPI_CONTROL_Pos)     ///< Positioning of SPI Control field in the ARM_SPI structure.
...
#define ARM_SPI_FRAME_FORMAT_Pos         8                                  ///< Position of the 0th bit of the Frame format field in the ARM_SPI structure.
#define ARM_SPI_FRAME_FORMAT_Msk        (7UL << ARM_SPI_FRAME_FORMAT_Pos)   ///< Positioning of Frame format field in the ARM_SPI structure.
...
#define ARM_SPI_DATA_BITS_Pos            12										///< Position of the 0th bit of the Data bits field in the ARM_SPI structure.
#define ARM_SPI_DATA_BITS_Msk           (0x3FUL << ARM_SPI_DATA_BITS_Pos)       ///< Positioning of the Data bits field in the ARM_SPI structure.
#define ARM_SPI_DATA_BITS(n)            (((n) & 0x3F) << ARM_SPI_DATA_BITS_Pos) ///< Number of Data bits.

/*----- SPI Control Codes: Mode Parameters: Bit Order -----*/
#define ARM_SPI_BIT_ORDER_Pos            18                                 ///< Position of the 0th bit of the Bit order field in the ARM_SPI structure.
#define ARM_SPI_BIT_ORDER_Msk           (1UL << ARM_SPI_BIT_ORDER_Pos)      ///< Positioning of the Bit order field in the ARM_SPI structure.
...
#define ARM_SPI_SS_MASTER_MODE_Pos       19                                 ///< Position of the 0th bit of the Slave Select Master Mode field in the ARM_SPI structure.
#define ARM_SPI_SS_MASTER_MODE_Msk      (3UL << ARM_SPI_SS_MASTER_MODE_Pos) ///< Positioning of the Slave Select Master Mode field in the ARM_SPI structure.
...
#define ARM_SPI_SS_SLAVE_MODE_Pos        21                                 ///< Position of the 0th bit of the Slave Select Slave Mode field in the ARM_SPI structure.
#define ARM_SPI_SS_SLAVE_MODE_Msk       (1UL << ARM_SPI_SS_SLAVE_MODE_Pos)  ///< Positioning of the Slave Select Slave mode field in the ARM_SPI structure.
