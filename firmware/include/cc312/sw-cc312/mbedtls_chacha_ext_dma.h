...
/*!
 ...
 @brief Contains CryptoCell ChaCha external DMA APIs. See mbedtls_chacha_ext_dma.h.
...
int mbedtls_ext_dma_chacha_init(uint8_t *  pNonce,                                  /*!< [in] The nonce buffer.  */
                                ...
                                mbedtls_chacha_encrypt_mode_t  EncryptDecryptFlag,  /*!< [in] The ChaCha operation: Encrypt or Decrypt. */
                                uint32_t    dataSize                                /*!< [in] Input data length in Bytes */
                                );
