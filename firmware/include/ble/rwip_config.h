...
#define SLEEP_PROG_MARGIN   500      // 250 us
...
enum PARAM_ID
{
	...
	PARAM_ID_CH_ASSESS_PARAMS           = 0x90,
    PARAM_ID_DTM_ANT_ID_TO_PTRN_PARAMS  = 0x91,
	PARAM_ID_LPCLK_NO_XTAL32K           = 0x92,
    //SWMMN-1007
	PARAM_ID_CUSTOMIZED_HEAP_SIZE       = 0x93,
