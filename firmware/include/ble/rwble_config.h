...
#define BLE_DATA_BUF_NB_RX           (BLE_RX_DESC_NB + 0)
//MC-116
...
#define BLE_ACL_BUF_NB_TX            (BLE_ACTIVITY_MAX + 0)
...
#define BLE_ANTENNA_NB         MAX_SWITCHING_PATTERN_LEN

/// Maximum length of switching pattern
//SWMMN-270
//#define BLE_MAX_SW_PAT_LEN     12
#define BLE_MAX_SW_PAT_LEN     MAX_SWITCHING_PATTERN_LEN
