...
extern void srand_func (uint32_t seed);
 ...
 *  ****************************************************************************************
 */
#define CO_ABS(value) (((value) < 0) ? (0-(value)) : (value))
...
__INLINE uint16_t co_rand_hword(void)
{
	...
	return (uint16_t)(rand_func() & 0xFFFF);
}
